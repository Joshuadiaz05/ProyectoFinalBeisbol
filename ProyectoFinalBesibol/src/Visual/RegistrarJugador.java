...
public class RegistrarJugador extends JDialog {
	...
	public RegistrarJugador() {
		...
		contentPanel.setLayout(null);
		{
			...
			cBposicion.setModel(new DefaultComboBoxModel(new String[] {"Pitcher", "Catcher", "Primera base", "Segunda base", "Tercera base", "Short stop", "Left fielder", "Center fielder", "Right fielder", "Bateador designado"}));
