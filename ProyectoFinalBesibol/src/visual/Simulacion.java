...
public class Simulacion extends JDialog {
	...
	public Simulacion(String local, String visita) {
		...
		textField.setBounds(6, 17, 42, 45);
		panel_4.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(50, 17, 42, 45);
		...
		textField_3.setBounds(6, 95, 42, 45);
		panel_4.add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(50, 95, 42, 45);
		...
		JLabel lblJugador_5 = new JLabel(""+pitcher.getNombre()+" "+pitcher.getApellido());
		...
		JLabel lblJugador_2 = new JLabel(""+centerfield.getNombre()+" "+centerfield.getApellido());
		...
		JLabel lblJugador = new JLabel(""+leftfield.getNombre()+" "+leftfield.getApellido());
		...
		JLabel label_11 = new JLabel(""+rigthfield.getNombre()+" "+rigthfield.getApellido());
		label_11.setBounds(6, 234, 119, 20);
		panel_7.add(label_11);
		
		Jugadores shortstop = equipolocal.buscarJugadorbyposicion("Short stop");
		JLabel label_12 = new JLabel(""+shortstop.getNombre()+" "+shortstop.getApellido());
		label_12.setBounds(6, 193, 101, 20);
		panel_7.add(label_12);
		
		Jugadores TerceraBase = equipolocal.buscarJugadorbyposicion("Tercera base");
		JLabel label_13 = new JLabel(""+TerceraBase.getNombre()+" "+TerceraBase.getApellido());
		...
		JLabel label_14 = new JLabel(""+segundabase.getNombre()+" "+segundabase.getApellido());
		...
		JLabel label_15 = new JLabel(""+primerabase.getNombre()+" "+primerabase.getApellido());
		label_15.setBounds(6, 72, 119, 20);
		panel_7.add(label_15);
		
		Jugadores catcher = equipolocal.buscarJugadorbyposicion("Catcher");
		JLabel labeljugador1 = new JLabel(""+catcher.getNombre()+" "+catcher.getApellido());
		...
		Jugadores pitcherv = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_4 = new JLabel(""+pitcherv.getNombre()+" "+pitcherv.getApellido());
		label_4.setBounds(6, 358, 119, 20);
		panel_9.add(label_4);
		
		Jugadores centerfieldv = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_5 = new JLabel(""+centerfieldv.getNombre()+" "+centerfieldv.getApellido());
		label_5.setBounds(6, 315, 119, 20);
		panel_9.add(label_5);
		
		Jugadores leftfieldv = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_6 = new JLabel(""+leftfieldv.getNombre()+" "+leftfieldv.getApellido());
		label_6.setBounds(6, 274, 119, 20);
		panel_9.add(label_6);
		
		Jugadores rigthfieldv = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_7 = new JLabel(""+rigthfieldv.getNombre()+" "+rigthfieldv.getApellido());
		label_7.setBounds(6, 234, 119, 20);
		panel_9.add(label_7);
		
		Jugadores shortstopv = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_8 = new JLabel(""+shortstopv.getNombre()+" "+shortstopv.getApellido());
		label_8.setBounds(6, 193, 119, 20);
		panel_9.add(label_8);
		
		Jugadores tercerabasev = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_9 = new JLabel(""+tercerabasev.getNombre()+" "+tercerabasev.getApellido());
		label_9.setBounds(6, 154, 119, 20);
		panel_9.add(label_9);
		
		Jugadores segundabasev = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_10 = new JLabel(""+segundabasev.getNombre()+" "+segundabasev.getApellido());
		label_10.setBounds(6, 111, 119, 20);
		panel_9.add(label_10);
		
		Jugadores primerabasev = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_17 = new JLabel(""+primerabasev.getNombre()+" "+primerabasev.getApellido());
		label_17.setBounds(6, 72, 119, 20);
		panel_9.add(label_17);
		
		Jugadores catcherv = equipovisita.buscarJugadorbyposicion("Catcher");
		JLabel label_18 = new JLabel(""+catcherv.getNombre()+" "+catcherv.getApellido());
